...
class BaseTrainer:
    ...
    def _setup_train(self, world_size):
        ...
        # distillation ___________________________________
        ...
        self.optimizer = self.build_optimizer(
            model=self.model,
            model1=self.Distillation, # distillation
    ...
    def _do_train(self, world_size=1):
        ...
        # distillation_______________________
        if self.Distillation is not None:
        ...
        while True:
            ...
            if RANK in {-1, 0}:
                ...
                # Validation
                # if (self.args.val and (epoch + 1) % self.args.val_interval == 1) or final_epoch or self.stopper.possible_stop or self.stop:
